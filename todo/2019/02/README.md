...
Find the input _noun_ and _verb_ that cause the program to produce the output `19690720`. _What is `100 _ noun + verb`?* (For example, if `noun=12`and`verb=2`, the answer would be `1202`.)
